    ...
    <div class="driver-form-lists-d">
      ...
      <div class="bottom">
        ...
        <div class="bottom-3-div">
          ...
          <h2 class="Trip-p">From Lagos to Uyo</h2>
          <h2 class="Date-p">(7 Aug 2020)</h2>
          <h2 class="Naira-p naira-red">N120</h2>
        </div>
        <div class="bottom-3-div">
          <img src="../assets/Vector_1.png" alt="check" class="check">
          <h2 class="Name-p">John Snow</h2>
...
.father-container .plc-div {
    ...
    .father-container .driver-form-lists-d {
    /* border: 1px dashed red; */
    width: 70%;
    height: 400px;
    margin-top: 30rem;
...
/* %%%%%%%%%%%%%%%%%%%%%%%%%
CSS FOR DRIVER LISTING
%%%%%%%%%%%%%%%%%%%%%%%%% */

.father-container .driver-form-lists-d .bottom {
    display: flex;
    flex-direction: column;
    justify-content: space-around;
    align-items: center;
...
.father-container .driver-form-lists-d .bottom-2-div {
    width: 80%;
    display: flex;
    flex-direction: row;
    justify-content: space-around;
...
.father-container .driver-form-lists-d .bottom-3-div {
    width: 80%;
    display: flex;
    flex-direction: row;
    justify-content: space-around;
    ...
    .father-container .driver-form-lists-d .hash,
    .father-container .driver-form-lists-d .name,
    .father-container .driver-form-lists-d .Trip,
    .father-container .driver-form-lists-d .Date,
    .father-container .driver-form-lists-d .Amount
      {
        font-family: Ubuntu;
        font-style: normal;
        font-weight: 500;
      ...
      .father-container .driver-form-lists-d .Name-p,
      .father-container .driver-form-lists-d .Trip-p,
      .father-container .driver-form-lists-d .Date-p,
      .father-container .driver-form-lists-d .Naira-p
    {
      ...
      .father-container .driver-form-lists-d .naira-red {
        color: #D82424;
      }
</style>
