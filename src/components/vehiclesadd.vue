  ...
  <div class="main-content-div">
    ...
    %%%%%%%%%%%%%%%% -->
     <div class="driver-form-lists-v">
      ...
      <div class="bottom">
        <div class="bottom-1-div">Vehicles</div>
        <div class="bottom-2-div">
          <h2 class="hash">#</h2>
          <h2 class="name">Name</h2>
          <h2 class="Trip">year</h2>
          <h2 class="Date">Registered Date</h2>
          <h2 class="Amount">Plate Number</h2>
        </div>
        <div class="bottom-3-div">
          <img src="../assets/Vector_1.png" alt="check" class="check">
          <h2 class="Name-p">John Snow</h2>
          <h2 class="Trip-p">2020</h2>
          <h2 class="Date-p">(7 Aug 2020)</h2>
          <h2 class="Naira-p naira-red">09865432176DR</h2>
        </div>
         <div class="bottom-3-div">
          <img src="../assets/Vector_1.png" alt="check" class="check">
          <h2 class="Name-p">John Snow</h2>
...
.father-container .plc-div {
    ...
    .father-container .driver-form-lists-v {
    /* border: 1px dashed red; */
    width: 70%;
    height: 400px;
    margin-top: 30rem;
